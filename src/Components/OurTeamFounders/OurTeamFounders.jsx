...
import ShaikhKashif1 from "./k4[1].jpg";
  ...
  const FoundersData = [
    {
      ...
      position: "Director",
      tagline:
        "Structural engineer with over 10+ years of experience specializing in high-rise buildings and infrastructure projects.",
      ...
      qualificationDetails: (
        <div>
          <ul>
            ...
            <li>
              Structural Engineer with 10+ years of experience in high-rise
              buildings, infrastructure, and industrial projects.
            </li>
            <li>
              Skilled at delivering innovative solutions for complex projects,
              including high-rises and large-scale developments.
            </li>
          </ul>
        </div>
      ),
    },
    {
      ...
      tagline:
        "Experienced engineering consultant with 20+ years in the industry, successfully delivering 200+ projects across sectors.",
      ...
      qualificationDetails: (
        <div>
          <ul>
            ...
            <li>
              Proficient consultant with over 20 years of experience in the MEP
              industry.
            </li>
            <li>
              Has successfully completed 200+ projects across various sectors.
            </li>
            <li>
              Leads branding, expansion, and growth strategies at Highbrow
              Engineering.
            </li>
          </ul>
        </div>
  ...
  const InverstorsDetails = [
    {
      ...
      details: (
        <>
          <p>
            Sayyad Wajed Ali, a Civil Engineering graduate from Dr. BAMU
            University, brings over 10 years of expertise in high-rise
            structures and infrastructure. As a Board of Director, he plays a
            key role in driving innovation and engineering excellence in the
            company.
          </p>
        </>
      ),
