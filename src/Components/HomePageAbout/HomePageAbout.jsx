                    ...
                    <Row>
                        ...
                        <Col lg={12} md={24}>
                            <div className="AboutHomeImageContainer">
                                <img style={{ transform: `translateY(${offsetY * 0.1}px)` }} src="https://images.unsplash.com/photo-1714113728562-6c67a7cb4542?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="about-us-highbrou-image" />
                            </div>
                        </Col>
                    </Row>
                </div>
